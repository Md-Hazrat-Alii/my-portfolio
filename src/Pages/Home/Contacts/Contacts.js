                    ...
                    <div>
                        <div className='bg-[#162033] w-[539px] h-auto p-5 border border-[#ffffff26] rounded-[8px] backdrop-blur-[12px] flex flex-start mt-5'>
                            ...
                            <div>
                                ...
                                <p className='text-[#fafafa] text-[16px] leading-[1.6] font-normal'>+491783567974</p>
                        ...
                        <div className='bg-[#162033] w-[539px] h-auto p-5 border border-[#ffffff26] rounded-[8px] backdrop-blur-[12px] flex flex-start mt-5'>
                            ...
                            <div>
                                ...
                                <p className='text-[#fafafa] text-[16px] leading-[1.6] font-normal'>hazratali4936@gmail.com</p>
                        ...
                        <div className='bg-[#162033] w-[539px] h-auto p-5 border border-[#ffffff26] rounded-[8px] backdrop-blur-[12px] flex flex-start mt-5'>
                            ...
                            <div>
                                ...
                                <p className='text-[#fafafa] text-[16px] leading-[1.6] font-normal'>Grüngurtstrasse 120, 50996 Cologne, Germany</p>
                            </div>
                        </div>
                    </div>
                </div>
